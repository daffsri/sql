...
,customer_last_name
,customer_first_name
,sum(quantity * cost_to_customer_per_qty) AS cost_total
...
-- create temp table copy of vendor
CREATE TEMP TABLE new_vendor AS
	SELECT *
	FROM vendor;

-- add row for 10th vendor
...
SELECT customer_id
,sum(quantity * cost_to_customer_per_qty) as spent_april_2022
FROM customer_purchases
